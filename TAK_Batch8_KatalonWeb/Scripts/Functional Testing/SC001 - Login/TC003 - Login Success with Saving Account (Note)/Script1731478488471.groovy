...
WebUI.click(findTestObject('Login Page/span_Remember me'))

WebUI.click(findTestObject('Login Page/button_Login'))

WebUI.callTestCase(findTestCase('Blocks/Navbar Logout'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Blocks/Navbar Login'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Login Page/input_Email'), email)

WebUI.verifyElementText(findTestObject('Login Page/input_Password'), password)
