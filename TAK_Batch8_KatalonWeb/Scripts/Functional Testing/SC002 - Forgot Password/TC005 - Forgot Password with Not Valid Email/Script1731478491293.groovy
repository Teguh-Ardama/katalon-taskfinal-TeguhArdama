...
WebUI.setText(findTestObject('Forgot Password Page/input_Email'), 'test')

WebUI.sendKeys(findTestObject('Forgot Password Page/input_Email'), Keys.chord(Keys.TAB))

WebUI.verifyElementPresent(findTestObject('Forgot Password Page/Error Message/mat-error_Email address is not valid'), 
    0)
