...
WebUI.verifyElementPresent(findTestObject('Forgot Password Page/Error Message/mat-icon_Error'), 0)
...
WebUI.verifyElementPresent(findTestObject('Forgot Password Page/Show Password Advice/span_contains at least one digit'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Forgot Password Page/Show Password Advice/span_contains at least 8 characters'), 
    0)
